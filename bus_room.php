...
if ($_SERVER["REQUEST_METHOD"] == "POST" || !$classroom) {
    ...
    $sql = "SELECT room_id, room_name, start_time, end_time, status, days, user_id FROM bus_rooms WHERE room_name = ?";
    ...
    <div class="locations">
        <form id="classroomForm" method="post" action="">
            ...
            <select id="classroom" name="classroom">
                <option value="BUS-0R-01" <?php if ($classroom == 'BUS-0R-01') echo 'selected'; ?>>BUS-0R-01</option>
                <option value="BUS-0R-02" <?php if ($classroom == 'BUS-0R-02') echo 'selected'; ?>>BUS-0R-02</option>
                <option value="BUS-0R-03" <?php if ($classroom == 'BUS-0R-03') echo 'selected'; ?>>BUS-0R-03</option>
