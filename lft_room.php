    ...
    <div class="locations">
        <form id="classroomForm" method="post" action="">
            ...
            <select id="classroom" name="classroom">
                <option value="LFT-0R-01" <?php if ($classroom == 'LFT-0R-01') echo 'selected'; ?>>LFT-0R-01</option>
                <option value="LFT-0R-02" <?php if ($classroom == 'LFT-0R-02') echo 'selected'; ?>>LFT-0R-02</option>
                <option value="LFT-0R-03" <?php if ($classroom == 'LFT-0R-03') echo 'selected'; ?>>LFT-0R-03</option>
...
<script>
    ...
    function lecturerOverride(room, day, time, studentId) {
        ...
        if (confirm('Are you sure you want to override this student booking? An email will be sent to notify them.')) {
            ...
            const formData = `room=${encodeURIComponent(room)}&day=${encodeURIComponent(day)}&time=${encodeURIComponent(time)}&student_id=${encodeURIComponent(studentId)}&room_type=lft`;
